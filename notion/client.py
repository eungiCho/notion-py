...
class NotionClient(object):
    ...
    def get_record_data(self, table, id, force_refresh=False, limit=1000):
    ...
    def search_pages_with_parent(self, parent_id, search="", limit=1000):
        data = {
            "query": search,
            "parentId": parent_id,
            "limit": limit,
    ...
    def search_blocks(self, search, limit=1000):
